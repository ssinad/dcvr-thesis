...
cycle_dcvr.o: $(CPPSRC)/cycle_dcvr.cpp
	g++ $(CCOBJ) -DIL_STD -I $(CPLEXINCDIR) -I $(CONCERTINCDIR) -Wno-overflow -Wno-ignored-attributes -o cycle_dcvr.o $(CPPSRC)/cycle_dcvr.cpp
